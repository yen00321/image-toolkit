...
const categoryContent: Record<ToolCategoryGroupId, CategoryContent> = {
  ...
  "social-media": {
    ...
    intro: [
      ...
      "Consistent sizing also helps when planning campaigns. Preparing assets in batches for each platform can make posts look intentional and reduce last-minute cropping surprises.",
      "It also makes approvals smoother.",
    ],
    faqs: [
      {
