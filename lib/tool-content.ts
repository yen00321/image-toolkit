...
export const toolContentBySlug: Record<string, ToolContent> = {
  ...
  "x-profile-picture": {
    explanation: [
      "X Profile Picture Resizer prepares square avatar images for X, formerly Twitter. Profile pictures appear beside posts, replies, direct messages, search results, profile cards, and notification previews, so the image needs to stay recognizable even when displayed very small. A clean square source helps reduce unexpected cropping before X presents the avatar in rounded or circular contexts.",
      "This tool is useful for creators, founders, writers, communities, newsletters, SaaS products, personal accounts, and brands that need a quick profile image export. The strongest avatars usually have one central subject, strong contrast, and minimal background clutter. If the image is a face, keep the eyes and head centered. If the image is a logo, leave enough padding around the mark so the circular crop does not trim important edges.",
      "The 400x400 preset gives you a predictable square output before uploading to X. It is not meant to replace a full brand design workflow; it is a practical final sizing step. Use a high-quality source, avoid tiny text, preview the result at a small size, and download a fresh copy so the original file remains unchanged.",
    ],
    howTo: [
      "Upload the photo, logo, or creator image you want to use.",
      "Apply the X Profile Picture 400x400 preset.",
      "Center the face, logo, or main subject inside the square.",
      "Keep enough margin so circular display crops do not cut off details.",
      "Download the resized profile picture.",
    ],
    features: [
      "Creates a square 400x400 image for X profile use.",
      "Helps prepare avatars for rounded and circular display contexts.",
      "Useful for creators, brands, communities, newsletters, and personal accounts.",
      "Encourages centered faces, logos, and simple marks.",
      "Works well with Crop Circle Image for avatar previewing.",
      "Browser-first workflow with no account required.",
    ],
    supportedFormats: "X Profile Picture Resizer supports common browser-readable images such as JPG, PNG, and WebP. The downloaded square image is generated locally from the browser canvas.",
    privacyNote: browserPrivacy,
    faqs: [
      { question: "What size should an X profile picture be?", answer: "A practical square preparation size is 400x400 pixels." },
      { question: "Is this the same as a Twitter profile picture?", answer: "Yes. The tool prepares a square avatar for X, the platform many users still refer to as Twitter." },
      { question: "Will X crop my image into a circle?", answer: "X often displays profile images in rounded or circular contexts, so keep the subject centered with enough padding." },
      { question: "Can I use a logo instead of a photo?", answer: "Yes. Simple logo marks work well when they have clear spacing and remain readable at small sizes." },
      { question: "Does the image leave my browser?", answer: browserPrivacy },
    ],
  },
  "pinterest-pin-resizer": {
    explanation: [
      "Pinterest Pin Resizer prepares vertical images for Pinterest-style pins using a 1000x1500 preset. Pinterest is highly visual and often rewards tall, clear images that communicate the subject quickly in a scrolling feed. A pin can be a recipe preview, product image, blog graphic, tutorial step, moodboard item, printable, travel idea, or shopping asset, but it needs a clean vertical composition to stand out.",
      "This tool is helpful when your source image is square, horizontal, or too large for a consistent pin layout. The 2:3 proportion gives enough vertical space for a strong subject, headline-style text, or supporting details without becoming overly long. Keep important text readable, avoid placing tiny labels near edges, and use a simple visual hierarchy so users understand the pin at a glance.",
      "The 1000x1500 preset creates a practical pin-sized export before uploading or scheduling content. If your image is a product photo, leave breathing room around the item. If it is a blog graphic, make the title large enough for mobile viewing. If you are repurposing a wide image, choose whether cropping or adding canvas space will preserve the message better.",
    ],
    howTo: [
      "Upload the image or graphic you want to turn into a pin.",
      "Apply the Pinterest Pin 1000x1500 preset.",
      "Position the main subject and text for a vertical 2:3 layout.",
      "Preview the result and avoid tiny details near the edges.",
      "Download the resized Pinterest pin image.",
    ],
    features: [
      "Creates a 1000x1500 vertical Pinterest pin image.",
      "Useful for blog graphics, products, recipes, tutorials, and inspiration posts.",
      "Helps convert square or horizontal images into a pin-friendly layout.",
      "Supports cleaner mobile feed presentation with a clear focal point.",
      "Works with compression tools before publishing.",
      "Processes supported images locally in the browser.",
    ],
    supportedFormats: "Pinterest Pin Resizer works with common browser-readable formats such as JPG, PNG, and WebP. The resized pin image is exported from the browser canvas.",
    privacyNote: browserPrivacy,
    faqs: [
      { question: "What size should a Pinterest pin be?", answer: "A common Pinterest pin preparation size is 1000x1500 pixels, which follows a 2:3 vertical ratio." },
      { question: "Can I resize a horizontal image for Pinterest?", answer: "Yes, but horizontal images usually need cropping or canvas space to fit a vertical pin format." },
      { question: "Should I add text to a Pinterest pin?", answer: "Text can work well, especially for guides or blog posts, but it should be large enough to read on mobile." },
      { question: "Is JPG or PNG better for pins?", answer: "JPG is usually good for photos and product images. PNG can be better for text-heavy graphics or crisp design elements." },
      { question: "Is my pin image uploaded to ImageToolkit?", answer: browserPrivacy },
    ],
  },
  "discord-avatar-resizer": {
    explanation: [
      "Discord Avatar Resizer prepares square 512x512 images for Discord profile avatars, server icons, community identities, and simple brand marks. Discord displays avatars in many small places, including chat messages, member lists, voice channels, profile popups, and server contexts, so the image should be bold, centered, and easy to recognize at small sizes.",
      "This tool is useful for personal accounts, creators, gaming communities, study groups, support communities, and small teams that need a clean avatar image. If the avatar is a face or character, keep it centered with enough margin. If it is a logo, avoid thin details and tiny text because Discord icons are often viewed at small sizes and may appear circular depending on context.",
      "The 512x512 preset gives a square export that works well as a starting point for Discord avatars. A simple background, strong contrast, and one main focal point usually produce a better result than a busy scene. For exact circular previewing, use the Crop Circle Image tool after resizing or keep the subject far enough from the corners.",
    ],
    howTo: [
      "Upload the image, logo, or avatar artwork you want to use.",
      "Apply the Discord Avatar 512x512 preset.",
      "Center the face, symbol, or main subject inside the square.",
      "Check that the design remains recognizable when viewed small.",
      "Download the resized Discord avatar image.",
    ],
    features: [
      "Creates a square 512x512 image for Discord avatar use.",
      "Useful for personal profiles, server icons, communities, and creator identities.",
      "Helps center faces, symbols, and logos before rounded display crops.",
      "Encourages clean high-contrast avatar designs.",
      "Pairs well with Crop Circle Image for circular previews.",
      "Browser-based processing with no account required.",
    ],
    supportedFormats: "Discord Avatar Resizer supports common browser-readable image formats including JPG, PNG, and WebP. The resized square output is generated locally in the browser.",
    privacyNote: browserPrivacy,
    faqs: [
      { question: "What size should a Discord avatar be?", answer: "A practical Discord avatar preparation size is 512x512 pixels." },
      { question: "Will Discord crop the avatar into a circle?", answer: "Discord often displays avatars in rounded or circular contexts, so keep important details centered with padding." },
      { question: "Can I use this for a Discord server icon?", answer: "Yes. A centered 512x512 square image is a useful starting point for many Discord icon workflows." },
      { question: "What makes a good Discord avatar?", answer: "Use one clear subject, strong contrast, simple background detail, and avoid small text." },
      { question: "Does ImageToolkit upload my avatar?", answer: browserPrivacy },
    ],
  },
  "tiktok-resizer": {
    explanation: [
      "TikTok Cover Resizer prepares vertical 1080x1920 images for TikTok video covers and mobile-first social visuals. A TikTok cover often appears in profile grids, previews, and share contexts, so it should be clear before someone taps the video. The vertical frame gives plenty of room, but interface overlays and grid cropping can make edge details less reliable.",
      "This tool is useful for creators, shops, educators, musicians, coaches, and brands that want a consistent cover style across short-form videos. A strong TikTok cover usually has one central subject, a readable headline, and enough contrast to work on a phone. Avoid putting critical text at the very top or bottom, and keep faces or products close to the center of the composition.",
      "The 1080x1920 preset creates a 9:16 export that can also be useful for other vertical platforms. If your original image is horizontal, decide whether cropping or adding canvas space better preserves the story. For cover images with text, resize first, then compress carefully so letters do not become blurry.",
    ],
    howTo: [
      "Upload the image or cover design you want to prepare.",
      "Apply the TikTok Video Cover 1080x1920 preset.",
      "Place the main subject and text near the center of the vertical frame.",
      "Avoid relying on small details near the top or bottom edges.",
      "Download the resized TikTok cover image.",
    ],
    features: [
      "Creates a 1080x1920 vertical TikTok cover image.",
      "Useful for short-form video covers, profile grids, and mobile previews.",
      "Helps convert photos or designs into a 9:16 layout.",
      "Encourages center-safe text and subject placement.",
      "Works well with image compression before uploading.",
      "Runs in the browser for supported image files.",
    ],
    supportedFormats: "TikTok Cover Resizer works with common browser-readable formats such as JPG, PNG, and WebP. The vertical output is generated from the browser canvas.",
    privacyNote: browserPrivacy,
    faqs: [
      { question: "What size should a TikTok cover image be?", answer: "A practical TikTok cover preparation size is 1080x1920 pixels, matching a vertical 9:16 format." },
      { question: "Can I use this for TikTok video thumbnails?", answer: "Yes. It prepares a vertical cover-style image that can be useful for TikTok video presentation." },
      { question: "Where should I place text?", answer: "Keep text large and near the center so it remains readable in mobile previews and profile grids." },
      { question: "Can I resize a landscape photo for TikTok?", answer: "Yes, but a landscape photo may need cropping or added canvas space to fit the vertical frame." },
      { question: "Is my TikTok cover processed locally?", answer: browserPrivacy },
    ],
  },
};
